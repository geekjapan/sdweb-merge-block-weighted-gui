...
def on_ui_tabs():
    with gr.Column():
        ...
        with gr.Row():
            with gr.Column():
                sl_IN_00 = gr.Slider(label="IN00", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_01 = gr.Slider(label="IN01", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_02 = gr.Slider(label="IN02", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_03 = gr.Slider(label="IN03", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_04 = gr.Slider(label="IN04", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_05 = gr.Slider(label="IN05", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_06 = gr.Slider(label="IN06", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_07 = gr.Slider(label="IN07", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_08 = gr.Slider(label="IN08", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_09 = gr.Slider(label="IN09", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_10 = gr.Slider(label="IN10", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_IN_11 = gr.Slider(label="IN11", minimum=-1, maximum=1, step=0.01, value=0.5)
            with gr.Column():
            ...
            with gr.Column():
                sl_OUT_11 = gr.Slider(label="OUT11", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_10 = gr.Slider(label="OUT10", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_09 = gr.Slider(label="OUT09", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_08 = gr.Slider(label="OUT08", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_07 = gr.Slider(label="OUT07", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_06 = gr.Slider(label="OUT06", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_05 = gr.Slider(label="OUT05", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_04 = gr.Slider(label="OUT04", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_03 = gr.Slider(label="OUT03", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_02 = gr.Slider(label="OUT02", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_01 = gr.Slider(label="OUT01", minimum=-1, maximum=1, step=0.01, value=0.5)
                sl_OUT_00 = gr.Slider(label="OUT00", minimum=-1, maximum=1, step=0.01, value=0.5)
