...
def on_ui_tabs():
    with gr.Column():
        ...
        with gr.Row():
            with gr.Column():
                sl_IN_A_00 = gr.Slider(label="IN_A_00", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_00")
                sl_IN_A_01 = gr.Slider(label="IN_A_01", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_01")
                sl_IN_A_02 = gr.Slider(label="IN_A_02", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_02")
                sl_IN_A_03 = gr.Slider(label="IN_A_03", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_03")
                sl_IN_A_04 = gr.Slider(label="IN_A_04", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_04")
                sl_IN_A_05 = gr.Slider(label="IN_A_05", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_05")
                sl_IN_A_06 = gr.Slider(label="IN_A_06", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_06")
                sl_IN_A_07 = gr.Slider(label="IN_A_07", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_07")
                sl_IN_A_08 = gr.Slider(label="IN_A_08", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_08")
                sl_IN_A_09 = gr.Slider(label="IN_A_09", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_09")
                sl_IN_A_10 = gr.Slider(label="IN_A_10", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_10")
                sl_IN_A_11 = gr.Slider(label="IN_A_11", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_A_11")
            with gr.Column():
                sl_IN_B_00 = gr.Slider(label="IN_B_00", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_00")
                sl_IN_B_01 = gr.Slider(label="IN_B_01", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_01")
                sl_IN_B_02 = gr.Slider(label="IN_B_02", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_02")
                sl_IN_B_03 = gr.Slider(label="IN_B_03", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_03")
                sl_IN_B_04 = gr.Slider(label="IN_B_04", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_04")
                sl_IN_B_05 = gr.Slider(label="IN_B_05", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_05")
                sl_IN_B_06 = gr.Slider(label="IN_B_06", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_06")
                sl_IN_B_07 = gr.Slider(label="IN_B_07", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_07")
                sl_IN_B_08 = gr.Slider(label="IN_B_08", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_08")
                sl_IN_B_09 = gr.Slider(label="IN_B_09", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_09")
                sl_IN_B_10 = gr.Slider(label="IN_B_10", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_10")
                sl_IN_B_11 = gr.Slider(label="IN_B_11", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_IN_B_11")
            with gr.Column():
            ...
            with gr.Column():
                ...
                gr.Slider(visible=False)
                gr.Slider(visible=False)
                sl_M_B_00 = gr.Slider(label="M_B_00", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_M_B_00")
            with gr.Column():
                sl_OUT_A_11 = gr.Slider(label="OUT_A_11", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_11")
                sl_OUT_A_10 = gr.Slider(label="OUT_A_10", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_10")
                sl_OUT_A_09 = gr.Slider(label="OUT_A_09", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_09")
                sl_OUT_A_08 = gr.Slider(label="OUT_A_08", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_08")
                sl_OUT_A_07 = gr.Slider(label="OUT_A_07", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_07")
                sl_OUT_A_06 = gr.Slider(label="OUT_A_06", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_06")
                sl_OUT_A_05 = gr.Slider(label="OUT_A_05", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_05")
                sl_OUT_A_04 = gr.Slider(label="OUT_A_04", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_04")
                sl_OUT_A_03 = gr.Slider(label="OUT_A_03", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_03")
                sl_OUT_A_02 = gr.Slider(label="OUT_A_02", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_02")
                sl_OUT_A_01 = gr.Slider(label="OUT_A_01", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_01")
                sl_OUT_A_00 = gr.Slider(label="OUT_A_00", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_A_00")
            with gr.Column():
                sl_OUT_B_11 = gr.Slider(label="OUT_B_11", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_11")
                sl_OUT_B_10 = gr.Slider(label="OUT_B_10", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_10")
                sl_OUT_B_09 = gr.Slider(label="OUT_B_09", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_09")
                sl_OUT_B_08 = gr.Slider(label="OUT_B_08", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_08")
                sl_OUT_B_07 = gr.Slider(label="OUT_B_07", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_07")
                sl_OUT_B_06 = gr.Slider(label="OUT_B_06", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_06")
                sl_OUT_B_05 = gr.Slider(label="OUT_B_05", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_05")
                sl_OUT_B_04 = gr.Slider(label="OUT_B_04", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_04")
                sl_OUT_B_03 = gr.Slider(label="OUT_B_03", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_03")
                sl_OUT_B_02 = gr.Slider(label="OUT_B_02", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_02")
                sl_OUT_B_01 = gr.Slider(label="OUT_B_01", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_01")
                sl_OUT_B_00 = gr.Slider(label="OUT_B_00", minimum=-1, maximum=1, step=0.01, value=0.5, elem_id="sl_OUT_B_00")
